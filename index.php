    ...
    <div class="container">
        ...
        <section>
            <article class="entry">
                <div class="row">
                    <div class="span8">
                        <h2 class="entry-title">Blog post title goes here</h2>
                    </div><!--/.span8-->
                </div><!--/.row-->
                <div class="row">
                    <div class="span2 entry-meta">
                        <p class="entry-author">By <a href="javascript:void(0);">Author Name</a></p>
                        <p class="entry-date">January 1, 1970</p>
                        <p class="entry-comments"><a href="javascriptLvoid(0);">23 comments</a></p>
                        <h3>Tagged:</h3>
                        <p>
                            <a href="javascript:void(0);">Tag one</a>,
                            <a href="javascript:void(0);">Tag two</a>,
                            <a href="javascript:void(0);">Tag three</a>,
                            <a href="javascript:void(0);">Tag four</a>
                        </p>
                        <h3>Categorized:</h3>
                        <p>
